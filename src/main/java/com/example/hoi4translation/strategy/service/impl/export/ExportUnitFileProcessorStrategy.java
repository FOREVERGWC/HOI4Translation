...
public class ExportUnitFileProcessorStrategy implements ExportFileProcessorStrategy {
    private final WordKey wordKey;
    private final String[] keys;


    public ExportUnitFileProcessorStrategy(WordKey wordKey, String... valueKeys) {
